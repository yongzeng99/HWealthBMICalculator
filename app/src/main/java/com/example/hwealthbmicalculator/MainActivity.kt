...
class MainActivity : AppCompatActivity() {
    ...
    private fun calculateBMI(){
        ...
        if (result < 18.5){
            ...
            setResult.setText("Your Category :" + String.format("%s", setTextResult.setText("Underweight")))
        } else if (result >= 18.5 && result <= 24.9) {
            setTextResult.setTextColor(Color.parseColor("##40ff49"));
            setResult.setText("Your Category :" + setTextResult.setText("Normal"))
        } else if (result >= 25 && result <= 29.9){
            setTextResult.setTextColor(Color.parseColor("#ffa217"));
            setResult.setText("Your Category :" + setTextResult.setText("Overweight"))
        } else if (result >= 30){
            setTextResult.setTextColor(Color.parseColor("##ff2626"));
            setResult.setText("Your Category :" + setTextResult.setText("Obese"))
        }
    ...
    private fun resetBMI(){
        ...
        setResult.setText("Your Category : ")
